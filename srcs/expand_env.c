...
/*   Updated: 2022/03/05 17:59:19 by kkaneko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	do_expand(char *str)
{
	...
	{
		if (str[i] == '$')
			env_value = get_env_value_from_dollar(&str[i]);
		++i;
	}
}

//str[0] is $
static char	*get_env_value_from_dollar(char *str)
{
	char	*env_name;
	size_t	env_start_i;
	size_t	env_len;
